...
rules:
  ...
  frontmatter:
    ...
    # Current V6 writes the base 8 keys plus migration metadata. Legacy V4/V5
    # pages with only the base 8 keys remain readable. The validator script
    # scripts/validate_novel_wiki_frontmatter.py is the source of truth.
  body:
    min_length: 1
