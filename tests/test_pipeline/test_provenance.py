...
# V4 NOTE: TestFrontmatterV4OmitsKoExtra class REMOVED.
# V6 (post-ADR-002 migration) DOES emit _ko_extra to disk.
# _ko_extra is a V6 18-key whitelist field, not V4 in-memory only.
# ---------------------------------------------------------------------------
