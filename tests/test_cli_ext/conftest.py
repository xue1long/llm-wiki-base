"""Local test config for test_cli_ext/.

Stub heavy optional dependencies so test_cli_ext modules can be imported
...
Mirrors tests/test_pipeline/conftest.py + tests/test_server/conftest.py.
"""
import sys
import types
...
_tavily_stub.TavilyClient = type("TavilyClient", (), {})
