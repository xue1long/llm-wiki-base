"""Local test config for test_llm/.

Stub heavy optional dependencies so test_llm modules can be imported
even when those packages are not installed in the dev environment.
Mirrors tests/test_server/conftest.py + tests/test_lib/conftest.py.
"""
import sys
import types
