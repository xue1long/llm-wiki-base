"""Local test config for test_sync/.

Stubs heavy optional deps so the sync tests can be collected even when those
packages are not installed. Production imports still require these.
"""
import sys
import types
