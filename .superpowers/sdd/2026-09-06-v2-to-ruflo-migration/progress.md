...
- Historical live apply predates durable promotion records; a non-destructive backfill was completed and rollback dry-run identified 5,301 authenticated paths for `migration-20260910`.
