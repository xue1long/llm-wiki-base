...
def create_app() -> FastAPI:
    ...
    from .routes import health, projects, files, search, ingest, reviews, chat, schema, agent_cli, analysis, providers, tags, quality, heat, templates, scenario_templates, capture, collect, kc
    for router in [health.router, projects.router, files.router, search.router,
                   ...
                   analysis.router, providers.router, tags.router, quality.router, heat.router, templates.router, scenario_templates.router, capture.router, collect.router, kc.router]:
