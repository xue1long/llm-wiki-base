...
def create_app() -> FastAPI:
    ...
    from .routes import health, projects, files, search, ingest, reviews, chat, schema, agent_cli, analysis, providers, tags, quality
    for router in [health.router, projects.router, files.router, search.router,
                   ...
                   analysis.router, providers.router, tags.router, quality.router]:
